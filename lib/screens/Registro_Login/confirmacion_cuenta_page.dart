                  ...
                  child: Column(
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          '"' +
                              widget.cadena.nombre +
                              '", gracias por elegir BovinApp como tu software para la gestión de tu ganado bovino y de tu finca. Estas a un paso de disfrutar de todas las opciones y caracteristicas de la App. Por favor valida tus datos e ingresa el código de la finca que fue enviado al correo "' +
                              (widget.cadena.email) +
                              '" para continuar',
                          style: TextStyle(
                            color: Colors.black,
